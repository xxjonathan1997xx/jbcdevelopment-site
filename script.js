...
const translations = {
  es: {
    ...
    "Email support@jbcdevelopment.dev for support, app, download, setup, privacy, or software questions.": "Escribe a support@jbcdevelopment.dev para preguntas de soporte, apps, descargas, configuracion, privacidad o software.",
    ...
    "For privacy, support, or app-related questions, email support@jbcdevelopment.dev.": "Para preguntas de privacidad, soporte o apps, escribe a support@jbcdevelopment.dev.",
